...
HD_PWD='/home/intern/Bendaou/stage_2025/Code VHDL/project/impl_results/MAC/500MHz/impl_MAC_500MHz.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_MAC_Test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_MAC_Test.tcl
