...
HD_PWD='/home/intern/Bendaou/stage_2025/Code VHDL/project/impl_results/MAC/550MHz/impl_MAC_550MHz.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_MAC_Test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_MAC_Test.tcl -notrace
