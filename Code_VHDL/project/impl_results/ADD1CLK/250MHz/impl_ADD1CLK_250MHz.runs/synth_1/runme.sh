...
HD_PWD='/home/intern/Bendaou/stage_2025/Code VHDL/project/impl_results/ADD1CLK/250MHz/impl_ADD1CLK_250MHz.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log addition_1clk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source addition_1clk.tcl
