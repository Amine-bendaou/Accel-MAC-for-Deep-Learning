...
HD_PWD='/home/intern/Bendaou/stage_2025/Code VHDL/project/impl_results/FPAdd/150MHz/impl_FPAdd_150MHz.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_FPAdd_Test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_FPAdd_Test.tcl
