...
HD_PWD='/home/intern/Bendaou/stage_2025/Code VHDL/project/impl_results/FPMAC/600MHz/impl_FPMAC_600MHz.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_FPMAC_Test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_FPMAC_Test.tcl
