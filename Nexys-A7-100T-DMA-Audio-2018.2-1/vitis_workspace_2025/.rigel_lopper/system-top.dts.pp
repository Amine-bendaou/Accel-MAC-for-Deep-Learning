# 0 "/home/intern/Downloads/Nexys-A7-100T-DMA-Audio-2018.2-1/vitis_workspace_2025/platform2/hw/sdt/system-top.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/intern/Downloads/Nexys-A7-100T-DMA-Audio-2018.2-1/vitis_workspace_2025/platform2/hw/sdt/system-top.dts"
/dts-v1/;
# 1 "/home/intern/Downloads/Nexys-A7-100T-DMA-Audio-2018.2-1/vitis_workspace_2025/platform2/hw/sdt/pl.dtsi" 1
/ {
 ...
 amba_pl: amba_pl {
  ...
  microblaze_0_axi_intc: interrupt-controller@41200000 {
   ...
   xlnx,s-axi-aclk-freq-mhz = <0x4d7bee1>;
   xlnx,num-sw-intr = <0>;
   ...
   xlnx,processor-clk-freq-mhz = <0x4d7bee1>;
   status = "okay";
   xlnx,is-fast = <0x1>;
   xlnx,has-fast = <1>;
   xlnx,ivar-rst-val = <0x10>;
   interrupt-controller;
   xlnx,async-intr = <0xfffffffd>;
   xlnx,name = "microblaze_0_axi_intc";
  };
  FP_Mult_0: FP_Mult@44a00000 {
   xlnx,exp-width = <5>;
   xlnx,s00-axi-data-width = <32>;
   compatible = "xlnx,FP-Mult-1.0";
   status = "okay";
   xlnx,s00-axi-addr-width = <4>;
   xlnx,ip-name = "FP_Mult";
   xlnx,edk-iptype = "PERIPHERAL";
  ...
  axi_uartlite_0: serial@40600000 {
   ...
   xlnx,s-axi-aclk-freq-hz-d = <0x4d7bee1>;
...
# 3 "/home/intern/Downloads/Nexys-A7-100T-DMA-Audio-2018.2-1/vitis_workspace_2025/platform2/hw/sdt/system-top.dts" 2
/ {
 board = "nexys-a7-100t";
 ...
 cpus_microblaze_0: cpus_microblaze@0 {
  address-map = <0x00000000 &microblaze_0_local_memory_dlmb_bram_if_cntlr_memory 0x00000000 0x2000>,
         <0x00000000 &microblaze_0_local_memory_dlmb_bram_if_cntlr 0x00000000 0x2000>,
         ...
         <0x44a00000 &FP_Mult_0 0x44a00000 0x10000>;
